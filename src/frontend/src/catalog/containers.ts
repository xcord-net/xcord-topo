...
export const containerDefinitions: ContainerDefinition[] = [
  ...
  },
  {
    ...
    configFields: [
      ...
      { key: 'rateLimit', label: 'Rate Limit', placeholder: '100/min' },
    ],
  ...
  },
  {
    ...
    configFields: [
      ...
      { key: 'tierProfile', label: 'Tier Profile', type: 'select', optionsFrom: 'tierProfiles' },
    ],
  ...
  },
  {
    ...
    description: 'Dedicated data service host pool (PG, Redis, MinIO) with published ports',
  },
  {
    kind: 'Dns',
    label: 'DNS Zone',
